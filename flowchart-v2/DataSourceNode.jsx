...
const DataSourceNode = ({ data }) => {
  ...
  return (
    <div className=" rounded overflow-hidden bg-white border-l-4 border-yellow-500 p-2 rounded-lg shadow-md w-[12rem]">
        <Handle
        type="target"
        position="left"
        id="agentLeft"
      ...
      />
        ...
        <div className="px-4 py-1.5 px-1.5 border-b border-gray-300 flex items-center">
            <FiDatabase className="h-2 w-2 text-red-500 mr-1" /> {/* Smaller Icon */}
            <span className="text-red-500 font-medium text-[0.6rem] leading-3">Datasource</span> {/* Reduced line height */}
        </div>
